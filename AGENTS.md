...
- Agent harness: Pi/Mastra-aligned architecture, module mapping, phased roadmap, and test matrix in `doc/agents.md`; runtime under `apps/desktop/src/main/agents/` with `settings.agents` default `enabled=false`
