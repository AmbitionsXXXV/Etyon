...
- Agent harness: Etyon-owned architecture, reference mapping, phased roadmap, and test matrix in `doc/agents.md`; runtime under `apps/desktop/src/main/agents/` with `settings.agents` default `enabled=false`
